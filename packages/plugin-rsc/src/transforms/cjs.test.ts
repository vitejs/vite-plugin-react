...
`
    expect(await testTransform(input)).toMatchInlineSnapshot(`
      "let __filename = "/test.js"; let __dirname = "/";
      let exports = {}; const module = { exports };
      function __cjs_interop__(m) { return m?.__cjs_module_runner_transform ? m.default : m?.default && Object.keys(m).every(k => k === "default" || m[k] === m.default[k] || m[k] === m.default) ? m.default : m; }
      if (true) {
