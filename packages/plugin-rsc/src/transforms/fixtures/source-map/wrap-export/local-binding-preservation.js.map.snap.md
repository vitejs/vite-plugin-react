...
(2:0) "const indirect = async () => {}\n" --> (2:0) "const indirect = async () => {}\n"
(5:0) "consume(direct, indirect)\n" --> (5:0) "consume(direct, indirect)\n"
[unmapped] --> (7:0) "const $$module_0_binding_direct = Object.defineProperty(registerServerReference(direct, \"direct\"), \"name\", { value: \"direct\" });\n"
[unmapped] --> (8:0) "export { $$module_0_binding_direct as direct };\n"
[unmapped] --> (9:0) "const $$module_1_binding_indirect = registerServerReference(indirect, \"indirect\");\n"
