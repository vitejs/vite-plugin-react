...
(1:26) "('./cjs/use-sync-external-store.production.js')" --> (4:48) "('./cjs/use-sync-external-store.production.js')))"
(1:73) ";\n" --> (4:97) ";\n"
(2:0) "} else {\n" --> (5:0) "} else {\n"
(3:0) "  module.exports = require" --> (6:0) "  module.exports = (__cjs_interop__(await import"
(3:26) "('./cjs/use-sync-external-store.development.js')" --> (6:48) "('./cjs/use-sync-external-store.development.js')))"
(3:74) ";\n" --> (6:98) ";\n"
(4:0) "}\n" --> (7:0) "}\n"
