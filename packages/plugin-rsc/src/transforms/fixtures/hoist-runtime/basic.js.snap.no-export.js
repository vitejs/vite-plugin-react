...
const $$hoist_0_noCapture = /* #__PURE__ */ $$register($$hoist_0_noCapture$$impl, "<id>", "$$hoist_0_noCapture");
const $$hoist_1_capture = /* #__PURE__ */ $$register($$hoist_1_capture$$impl, "<id>", "$$hoist_1_capture");
const $$hoist_2_exported = /* #__PURE__ */ $$register($$hoist_2_exported$$impl, "<id>", "$$hoist_2_exported");
